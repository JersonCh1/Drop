...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl shadow-gray-200/50 p-8 border border-gray-100 hover:shadow-3xl hover:shadow-blue-200/30 transition-all duration-300">
      ...
      <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-blue-500/10 to-cyan-500/10 rounded-full blur-3xl -z-10"></div>

      <div className="space-y-6">
        {/* Product Title */}
        <div className="relative">
          <div className="absolute -left-2 top-0 w-1 h-8 bg-gradient-to-b from-blue-600 to-cyan-600 rounded-full"></div>
          <h2 className="text-3xl font-extrabold bg-gradient-to-r from-gray-900 via-blue-900 to-cyan-900 bg-clip-text text-transparent mb-3">
            ...
            {models.map((model) => (
              <button
                ...
                className={`group relative p-4 border-2 rounded-2xl text-sm font-bold transition-all duration-300 transform hover:scale-105 ${
                  selectedModel === model
                    ? 'border-blue-500 bg-gradient-to-br from-blue-50 to-cyan-50 text-blue-700 shadow-lg shadow-blue-200/50'
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-gray-50 to-blue-50 p-5 rounded-2xl border border-gray-200">
          <div className="absolute bottom-0 right-0 w-40 h-40 bg-gradient-to-br from-blue-400/10 to-cyan-400/10 rounded-full blur-2xl"></div>
          <h4 className="font-bold text-gray-900 mb-4 flex items-center">
            <span className="w-8 h-8 bg-gradient-to-br from-blue-600 to-cyan-600 rounded-lg flex items-center justify-center mr-2">
