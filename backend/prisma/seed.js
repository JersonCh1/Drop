...
async function main() {
  ...
  await prisma.productImage.createMany({
    data: [
      ...
      { productId: 'prod_case_iphone15_trans', url: 'https://images.unsplash.com/photo-1592286927505-0b5fe0b5a7f3?w=800', altText: 'Carcasa Transparente iPhone 15', position: 0, isMain: true },
      { productId: 'prod_case_iphone15_trans', url: 'https://images.unsplash.com/photo-1574944985070-8f3ebc6b79d2?w=800', altText: 'Vista lateral', position: 1, isMain: false },

      // iPhone 14 Silicona
      { productId: 'prod_case_iphone14_silicone', url: 'https://images.unsplash.com/photo-1556656793-08538906a9f8?w=800', altText: 'Carcasa Silicona iPhone 14', position: 0, isMain: true },
      { productId: 'prod_case_iphone14_silicone', url: 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=800', altText: 'Vista posterior', position: 1, isMain: false },

      // iPhone 13 Cuero
      { productId: 'prod_case_iphone13_leather', url: 'https://images.unsplash.com/photo-1565849904461-04a58ad377e0?w=800', altText: 'Carcasa Cuero iPhone 13', position: 0, isMain: true },
      { productId: 'prod_case_iphone13_leather', url: 'https://images.unsplash.com/photo-1585060544812-6b45742d762f?w=800', altText: 'Detalle cuero', position: 1, isMain: false },

      // iPhone 15 Pro Antigolpes
      { productId: 'prod_case_iphone15pro_rugged', url: 'https://images.unsplash.com/photo-1601784551446-20c9e07cdbdb?w=800', altText: 'Carcasa Antigolpes', position: 0, isMain: true },

      // Protector
      { productId: 'prod_screen_protector', url: 'https://images.unsplash.com/photo-1598327105666-5b89351aff97?w=800', altText: 'Protector de Pantalla', position: 0, isMain: true },
    ],
  });
